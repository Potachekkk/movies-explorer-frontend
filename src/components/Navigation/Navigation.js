  ...
  return (
    <nav className='nav'>
      ...
      ? (
        ...
        <button type='button' onClick={handleCloseButtonClick} className='nav__close-button-link'/>
        ...
        <div className='nav__item'>
          <Link to='/profile' className='nav__acc'>
            <p className={`nav__acc-text ${pathname === '/profile' ? 'nav__acc-text_active' : ''}`}>Аккаунт</p>
          </Link>
        </div>
        </div> </div>
        </>)
